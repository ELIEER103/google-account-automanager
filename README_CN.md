...
> **Fork 说明**: 本项目基于 [Leclee/auto_bitbrowser](https://github.com/Leclee/auto_bitbrowser) 二次开发，新增了多项功能并修复了原项目中的问题。
...
### 新增功能
- **按状态批量删除** - 支持按特定状态类型批量删除账号
- **批量修改密码** - 自动化密码修改流程
- **资格验证** - 检测学生资格状态
- **2FAGuard 导出** - 一键导出兼容 2FAGuard 格式的 2FA 密钥文件

### Bug 修复与优化
- 修复 `set_language.py` 中的语言检测逻辑 - 现在检查页面实际内容而非不可靠的 HTML lang 属性
- 改进业务逻辑流程和错误处理
- 增强多账号批量操作的稳定性
...
本项目基于以下项目开发：
- [Leclee/auto_bitbrowser](https://github.com/Leclee/auto_bitbrowser) - 直接上游
- [16627517673/bitbrowser-automation](https://github.com/16627517673/bitbrowser-automation) - 原始项目
